 ...
 * @author ASUS
 */
public class GovernmentView extends javax.swing.JFrame {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(GovernmentView.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
